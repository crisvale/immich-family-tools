...
export const translations = {
  ...
  conditional_album_new: {
    de: "Bedingtes Album",
    en: "Conditional album",
    "pt-BR": "Álbum condicional",
    "es-ES": "Álbum condicional",
  },
  conditional_album_title: {
    de: "Bedingtes Album erstellen",
    en: "Create conditional album",
    "pt-BR": "Criar álbum condicional",
    "es-ES": "Crear álbum condicional",
  },
  conditional_album_hint: {
    de: "Fügt Fotos hinzu, auf denen mindestens die gewählte Anzahl dieser Personen gemeinsam zu sehen ist.",
    en: "Adds photos where at least the chosen number of these people appear together.",
    "pt-BR": "Adiciona fotos em que pelo menos o número escolhido dessas pessoas apareça junto.",
    "es-ES":
      "Añade fotos en las que aparezcan juntas al menos el número elegido de estas personas.",
  },
  conditional_album_owner: {
    de: "Besitzer-Account",
    en: "Owner account",
    "pt-BR": "Conta proprietária",
    "es-ES": "Cuenta propietaria",
  },
  conditional_album_name_ph: {
    de: "z. B. Familie",
    en: "e.g. Family",
    "pt-BR": "ex.: Família",
    "es-ES": "p. ej., Familia",
  },
  conditional_album_people: {
    de: (n: number) => `Personen auswählen (${n} ausgewählt, mindestens 2)`,
    en: (n: number) => `Select people (${n} selected, at least 2)`,
    "pt-BR": (n: number) => `Selecionar pessoas (${n} selecionadas, pelo menos 2)`,
    "es-ES": (n: number) => `Selecciona personas (${n} seleccionadas, al menos 2)`,
  },
  conditional_album_minimum: {
    de: "Wie viele Personen müssen gemeinsam vorkommen?",
    en: "How many people must appear together?",
    "pt-BR": "Quantas pessoas devem aparecer juntas?",
    "es-ES": "¿Cuántas personas deben aparecer juntas?",
  },
  conditional_album_rule: {
    de: (minimum: number, total: number) => `Mindestens ${minimum} von ${total}`,
    en: (minimum: number, total: number) => `At least ${minimum} of ${total}`,
    "pt-BR": (minimum: number, total: number) => `Pelo menos ${minimum} de ${total}`,
    "es-ES": (minimum: number, total: number) => `Al menos ${minimum} de ${total}`,
  },
  conditional_album_create: {
    de: "Album erstellen",
    en: "Create album",
    "pt-BR": "Criar álbum",
    "es-ES": "Crear álbum",
  },
  conditional_album_close: {
    de: "Schließen",
    en: "Close",
    "pt-BR": "Fechar",
    "es-ES": "Cerrar",
  ...
  link_people_action: {
    de: "Personen verknüpfen",
    en: "Link people",
    "pt-BR": "Vincular pessoas",
    "es-ES": "Vincular personas",
  },
  link_people_success: {
    de: "Personen wurden als eine Identität verknüpft.",
    en: "People linked as one identity.",
    "pt-BR": "Pessoas vinculadas como uma identidade.",
    "es-ES": "Personas vinculadas como una identidad.",
  },
  linked_identities: {
    de: "Verknüpfte Identitäten",
    en: "Linked identities",
    "pt-BR": "Identidades vinculadas",
    "es-ES": "Identidades vinculadas",
  },
  linked_identity_badge: {
    de: "Verknüpft",
    en: "Linked",
    "pt-BR": "Vinculada",
    "es-ES": "Vinculada",
  ...
  linked_people_subtitle: {
    de: (n: number) => `${n} Identität${n === 1 ? "" : "en"} aus mehreren Accounts`,
    en: (n: number) => `${n} ${n === 1 ? "identity" : "identities"} across accounts`,
    "pt-BR": (n: number) => `${n} ${n === 1 ? "identidade" : "identidades"} entre contas`,
    "es-ES": (n: number) => `${n} ${n === 1 ? "identidad" : "identidades"} entre cuentas`,
  },
  linked_photo_total: {
    de: (total: string) => `${total} Fotos gesamt`,
    en: (total: string) => `${total} total photos`,
    "pt-BR": (total: string) => `${total} fotos no total`,
    "es-ES": (total: string) => `${total} fotos en total`,
  },
  linked_profile_count: {
    de: (n: number) => `${n} Quellprofile`,
    en: (n: number) => `${n} source profiles`,
    "pt-BR": (n: number) => `${n} perfis de origem`,
    "es-ES": (n: number) => `${n} perfiles de origen`,
  },
  linked_different_names: {
    de: "Die Quellprofile haben unterschiedliche Namen",
    en: "The source profiles use different names",
    "pt-BR": "Os perfis de origem usam nomes diferentes",
    "es-ES": "Los perfiles de origen usan nombres diferentes",
  },
  delete_link: {
    de: "Verknüpfung löschen",
    en: "Delete link",
    "pt-BR": "Excluir vínculo",
    "es-ES": "Eliminar vínculo",
  },
  delete_link_confirm: {
    de: "Diese Verknüpfung löschen? Bereits erstellte Alben behalten ihre gespeicherten Profile.",
    en: "Delete this link? Existing albums will keep their saved profiles.",
    "pt-BR": "Excluir este vínculo? Os álbuns existentes manterão os perfis salvos.",
    "es-ES": "¿Eliminar este vínculo? Los álbumes existentes conservarán sus perfiles guardados.",
  },
  person_covered_by_link: {
    de: "Diese Person ist bereits durch eine gewählte Identität abgedeckt.",
    en: "This person is already covered by a selected linked identity.",
    "pt-BR": "Esta pessoa já está incluída em uma identidade vinculada selecionada.",
    "es-ES": "Esta persona ya está incluida en una identidad vinculada seleccionada.",
  },
  ...
  err_invalid_person_threshold: {
    de: "Die Mindestanzahl muss zwischen 1 und der Anzahl ausgewählter Personen liegen",
    en: "The minimum must be between 1 and the number of selected people",
    "es-ES": "El mínimo debe estar entre 1 y el número de personas seleccionadas",
    "pt-BR": "O mínimo deve estar entre 1 e o número de pessoas selecionadas",
  },
  err_conditional_people_owner_only: {
    de: "Profile aus anderen Accounts müssen über eine verknüpfte Person ausgewählt werden",
    en: "Profiles from other accounts must be selected through a linked person",
    "es-ES": "Los perfiles de otras cuentas deben seleccionarse mediante una persona vinculada",
    "pt-BR": "Perfis de outras contas devem ser selecionados por meio de uma pessoa vinculada",
  },
  err_conditional_album_not_extendable: {
    de: "Bedingte Alben können nicht über „Match erweitern“ geändert werden",
    en: "Conditional albums cannot be changed through Extend Match",
    "es-ES": "Los álbumes condicionales no se pueden modificar mediante Ampliar coincidencia",
    "pt-BR": "Álbuns condicionais não podem ser alterados por meio de Estender correspondência",
  },
  err_linked_person_not_found: {
    de: "Verknüpfte Person nicht gefunden",
    en: "Linked person not found",
    "es-ES": "No se encontró la persona vinculada",
    "pt-BR": "Pessoa vinculada não encontrada",
  },
  err_linked_person_min_accounts: {
    de: "Profile aus mindestens 2 Accounts erforderlich",
    en: "Profiles from at least 2 accounts are required",
    "es-ES": "Se necesitan perfiles de al menos 2 cuentas",
    "pt-BR": "São necessários perfis de pelo menos 2 contas",
  },
  err_linked_person_one_per_account: {
    de: "Pro Account ist nur ein Profil je verknüpfter Person erlaubt",
    en: "Only one profile per account is allowed for each linked person",
    "es-ES": "Solo se permite un perfil por cuenta para cada persona vinculada",
    "pt-BR": "Apenas um perfil por conta é permitido para cada pessoa vinculada",
  },
  err_linked_person_conflict: {
    de: "Ein Profil gehört bereits zu einer inkompatiblen Verknüpfung",
    en: "A profile already belongs to an incompatible link",
    "es-ES": "Un perfil ya pertenece a un vínculo incompatible",
    "pt-BR": "Um perfil já pertence a um vínculo incompatível",
  },
  err_conditional_destination_required: {
    de: "Albumname oder vorhandenes Album erforderlich",
    en: "An album name or existing album is required",
    "es-ES": "Se necesita un nombre de álbum o un álbum existente",
    "pt-BR": "É necessário um nome de álbum ou um álbum existente",
  },
  err_conditional_destination_ambiguous: {
    de: "Nur Albumname oder vorhandenes Album darf angegeben werden",
    en: "Choose either an album name or an existing album, not both",
    "es-ES": "Elige un nombre de álbum o un álbum existente, no ambos",
    "pt-BR": "Escolha um nome de álbum ou um álbum existente, não ambos",
  },
  err_not_undoable: {
